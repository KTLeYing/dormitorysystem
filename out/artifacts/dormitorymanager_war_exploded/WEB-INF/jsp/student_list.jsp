    ...
    <div class="x-body">
        <div class="layui-row">
            <form class="layui-form layui-col-md12 x-so" action="${pageContext.request.contextPath}/findStudent" >
                <input class="layui-input" placeholder="请输入姓名" value="${s_name}" name="s_name" id="s_name">
                <input class="layui-input" placeholder="请输入学号" value="${s_studentid}" name="s_studentid" id="s_studentid">
                <input class="layui-input" placeholder="请输入班级编号" value="${s_classid}" name="s_classid" id="s_classid">
                <input class="layui-input" placeholder="请输入班级名" value="${s_classname}" name="s_classname" id="s_classname">
