...
//        admin.setA_password(MD5Util.MD5EncodeUtf8(admin.getA_password()));    //密码加密
        System.out.println(admin.getA_password());
    ...
    @ResponseBody
    public String addAdmin( @RequestBody Admin1 admin1) {
        Admin admin = new Admin();
        admin.setA_username(admin1.getA_username());

        System.out.println(admin1.getA_password());
        admin.setA_password(MD5Util.MD5EncodeUtf8(admin1.getA_password()));
        System.out.println(admin.getA_password());

        admin.setA_name(admin1.getA_name());
        admin.setA_phone(Integer.parseInt(admin1.getA_phone()));
        admin.setA_power(Integer.parseInt(admin1.getA_power()));
        admin.setA_describe(admin1.getA_describe());
    ...
    public String updateAdmin(Admin1 admin1) {
        Admin admin = new Admin();
        admin.setA_id(admin1.getA_id());
        admin.setA_username(admin1.getA_username());
