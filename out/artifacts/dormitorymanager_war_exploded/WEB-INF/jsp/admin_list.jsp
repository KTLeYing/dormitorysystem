...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="${pageContext.request.contextPath}/findAdmin" >
            <input type="hidden" class="layui-input" placeholder="请输入用户名" value="${a_id}" name="a_id" id="a_id">
            <input class="layui-input" placeholder="请输入用户名" value="${a_username}" name="a_username" id="a_username">
            <input class="layui-input" placeholder="请输入级别描述" value="${a_describe}" name="a_describe" id="a_describe" >
