...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="${pageContext.request.contextPath}/findDormitory" >
            <input class="layui-input" placeholder="请输入宿舍编号" value="${s_dormitoryid}" name="s_dormitoryid" id="s_dormitoryid">
            <input class="layui-input" placeholder="请输入宿舍楼" value="${d_dormbuilding}" name="d_dormbuilding" id="d_dormbuilding">
            <input class="layui-input" placeholder="请输入管理员姓名" value="${a_name}" name="a_name" id="a_name">
