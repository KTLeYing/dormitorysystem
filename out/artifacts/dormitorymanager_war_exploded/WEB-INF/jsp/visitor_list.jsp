...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="${pageContext.request.contextPath}/findVisitor" >
            <input class="layui-input" placeholder="请输入姓名" value="${v_name}" name="v_name" id="v_name">
            <input class="layui-input" placeholder="请输入电话" value="${v_phone}" name="v_phone" id="v_phone">
