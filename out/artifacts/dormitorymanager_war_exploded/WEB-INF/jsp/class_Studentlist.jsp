...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="${pageContext.request.contextPath}/findClassStudent" >
            <input class="layui-input" placeholder="请输入班级编号" value="${c_classid}" name="c_classid" id="c_classid">
            <input class="layui-input" placeholder="请输入班级名" value="${c_classname}" name="c_classname" id="c_classname">
    ...
    <c:if test="${empty cs and  empty c_classid and  empty c_classname}">
        <h2>请输入班级编号和班级名搜索</h2>
    </c:if>

    <c:if test="${empty cs and  not empty c_classid and not empty c_classname}">
        <h2>改班级暂无学生！</h2>
    </c:if>

    <c:if test="${empty cs and  not empty c_classid and empty c_classname}">
        <h2>请同时输入班级名搜索！</h2>
    </c:if>

    <c:if test="${empty cs and empty c_classid and not empty c_classname}">
        <h2>请同时输入班级编号搜索！</h2>
    </c:if>
