...
<div class="x-body">
    <form class="layui-form"  id="f_auto" action="${pageContext.request.contextPath}/updateDormRepair" method="post" >
        <input type="hidden" value="${d.r_id}" name="r_id" id="r_id"/>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="d_id" name="d_id"
                       autocomplete="off" value="${d.d_id}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="d_dormbuilding" name="d_dormbuilding"
                       autocomplete="off" value="${d.d_dormbuilding}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="r_name" name="r_name"
                       autocomplete="off" value="${d.r_name}" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="reason" name="reason"
                       autocomplete="off" value="${d.reason}" class="layui-input">
            </div>
        </div>

        <input type="hidden" value="${d.update_time}" name="update_time" id="update_time"/>
